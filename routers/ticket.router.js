...
const {createTicket, updateTicket, getAllTicket, getDetailTicket, deleteTicket, bookingTicket, cancelTicket, getAllTicketId, confirmTicket, getAllTicketTrip} = require("../backend-datVeXe/controllers/ticket.controller");
